...
vancomycin <- RNAseq.data$features$annotation.db$module.dict[['M00115']]
RNAseq.data$features$annotation.db <- list("module.dict" = list("vancomycin" = vancomycin),
                                           "all annotations in a module" = vancomycin)
...
clustered.distances <- Identify_Trait_Attributes()
```
