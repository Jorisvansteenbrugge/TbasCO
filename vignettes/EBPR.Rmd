...
annotation.db.path <- "D:/Users/JorisS/Downloads/PortableGit/TcT/data/KEGG_modules.tsv"
...
RNAseq.data$features$annotation.db <- list("module.dict" = list("PolyP" = polyP_module),
                                           "all annotations in a module" = polyP_module)

Calc_Pairwise_Annotation_Distance(RNAseq.data)
```
