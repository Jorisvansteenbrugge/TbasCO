...
trait.attributes.pruned <- Prune_Trait_Attributes(trait.attributes, bkgd.modules, RNAseq.data$features,
...
```{r}
require(arules)
ba <- apriori(sbs.trait.attributes,parameter = list(support = 0.2,
                                                   confidence = 0.9))
