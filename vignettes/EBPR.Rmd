...
```{r}
file.path          <- "D:/Users/JorisS/Downloads/PortableGit/TcT/data/sample_data_newKO.csv"
annotation.db.path <- "D:/Users/JorisS/Downloads/PortableGit/TcT/data/updated_KO_modules.tsv"

RNAseq.data_new <- Pre_process_input(file.path,
                                 annotation.db.path,
...
matches.per.genome_new <- sapply(RNAseq.data_new$features$bins,
       function(bin){
